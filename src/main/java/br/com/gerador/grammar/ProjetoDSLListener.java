...
public interface ProjetoDSLListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link ProjetoDSLParser#packageName}.
	 * @param ctx the parse tree
	 */
	void enterPackageName(ProjetoDSLParser.PackageNameContext ctx);
	/**
	 * Exit a parse tree produced by {@link ProjetoDSLParser#packageName}.
	 * @param ctx the parse tree
	 */
	void exitPackageName(ProjetoDSLParser.PackageNameContext ctx);
	/**
